...
public class ReportService {
        ...
        public WeeklyReportResponse getWeeklyReport(Long userId) {
                ...
                List<WeeklyReportResponse.InterestGap> interestGaps = calculateInterestGaps(savedThisWeek,
                                readThisWeek);
        ...
        public ConsumptionResponse getConsumption(Long userId) {
                ...
                List<ConsumptionResponse.RecentRead> recentReads = recentReadList.stream()
                                .map(un -> {
                                        ...
                                        String categoryName = (un.getNewsletter() != null
                                                        && un.getNewsletter().getCategory() != null)
                                        ...
                                        return new ConsumptionResponse.RecentRead(
                                                        ...
                                                        un.getNewsletter() != null ? un.getNewsletter().getTitle()
                                                                        : "삭제된 뉴스레터",
                                                        categoryName,
                                                        lastViewedDate);
